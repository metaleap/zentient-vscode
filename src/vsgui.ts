...
export function onActivate (disps: vs.Disposable[]) {
    if (!vsreg) {
        ...
        z.regEdCmd('zen.caps.intel', onCmdCaps("Code Intel", ["Completion Suggest", "Go to Definition", "Go to Type Definition", "Go to Interfaces/Implementers", "Hover Tips", "Semantic Highlighting", "Symbol Lookup"].join("</i>, <i>"), zconn.REQ_QUERY_CAPS, 'intel'))
