...
function refreshDiag (doc :vs.TextDocument = null) {
    ...
    if (doc && diag) {
        ...
        nonissues.push( new vs.Diagnostic(new vs.Range(0,0 , 1,0), "IntelliGible: this is the 1st line. For more \"diagnostics\",\ntype 'hint' or 'warning' or 'error' anywhere.", vs.DiagnosticSeverity.Information) )
